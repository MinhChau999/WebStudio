...
export const ensureMigrationTable = async () => {
  // MySQL version of migration table
  // Changed from PostgreSQL TIMESTAMPTZ to DATETIME
...
export const setStarted = async (migrationName: string, filePath: string) => {
  ...
  // MySQL doesn't support LIMIT in subquery with DELETE
  // Use a different approach: delete directly with conditions
